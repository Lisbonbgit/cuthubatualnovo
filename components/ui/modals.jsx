...
// Generic Success Modal - Following CopySuccessModal design pattern
export function SuccessModal({ isOpen, onClose, title, message, autoClose = true, autoCloseDelay = 2500 }) {
  const [isVisible, setIsVisible] = useState(false);
...
// Generic Error Modal - Following CopySuccessModal design pattern
export function ErrorModal({ isOpen, onClose, title, message }) {
  const [isVisible, setIsVisible] = useState(false);
